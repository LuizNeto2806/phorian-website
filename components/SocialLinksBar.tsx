    ...
    >
      {headerSocialLinks.map((link) => (
        <a
          ...
          className="inline-flex h-11 shrink-0 items-center justify-center px-1 text-white opacity-80 transition-opacity duration-300 ease-out hover:opacity-100 md:h-auto md:min-h-11 md:min-w-11 md:px-0"
        >
          <PlatformIcon
            name={link.name}
